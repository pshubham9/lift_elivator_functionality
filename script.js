...
//default lift css
document.getElementsByClassName("lift1")[0].style.backgroundColor = "#dfd8d8";
document.getElementsByClassName("lift2")[0].style.backgroundColor = "#dfd8d8";
let liftFloor = 0;
    ...
    if (activeLift == "lift1") {
      ...
      var liftNumUpdate = setInterval(() => {
        for (var j = 0; j < allElem1.length; j++) {
          allElem1[j].style.backgroundColor = "white";
        }
        prevNum++;
        allElem1[prevNum].style.backgroundColor = "#dfd8d8";
      ...
      var liftNumUpdate = setInterval(() => {
        for (var j = 0; j < allElem2.length; j++) {
          allElem2[j].style.backgroundColor = "white";
        }
        prevNum++;
        allElem2[prevNum].style.backgroundColor = "#dfd8d8";
  ...
  if (foundKey == "lift1") {
    ...
    var liftNumUpdate = setInterval(() => {
      ...
      if (prevNum < currNum) {
        ...
        allElem1[currNum].style.backgroundColor = "#dfd8d8";
      }
    }, 2000);
  } else if (foundKey == "lift2") {
    ...
    var liftNumUpdate = setInterval(() => {
      ...
      if (prevNum < currNum) {
        ...
        clearInterval(liftNumUpdate);
        alert("You are on same Floor");
        allElem2[currNum].style.backgroundColor = "#dfd8d8";
      }
    }, 2000);
  }
  // console.log(liftObj)
